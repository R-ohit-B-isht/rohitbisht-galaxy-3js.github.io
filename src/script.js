...
gui.add(parameters,'radius').min(.1).max(20).step(.01).onFinishChange(generateGalaxy)
...
gui.add(parameters,'randomnessPower').min(0).max(10).step(.001).onFinishChange(generateGalaxy)
